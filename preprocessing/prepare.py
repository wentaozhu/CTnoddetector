...
def savenpy(id,annos,filelist,data_path,prep_folder):        
    ...
    print im.shape, '_clean', sliceim.shape, '_originbox', extendbox.shape, '_space', spacing
...
#     resolution = np.array([2,2,2])
    ...
    if isClean:
        ...
        print mask.shape, '_clean', sliceim.shape, '_origin', origin.shape, '_spacing', spacing
